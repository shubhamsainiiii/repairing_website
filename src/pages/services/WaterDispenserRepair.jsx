            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex justify-center">
                    <div className="w-full max-w-6xl">
                        ...
                        <h3 className="text-lg font-bold mt-6 mb-2">Why Choose Us for Water Dispenser Services in Jaipur?</h3>
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-gray-800 text-lg mt-4 text-justify">
                        ...
                        <h3 className="text-xl font-bold mt-6 mb-2 flex flex-raw">Common Water Dispenser Issues We Expertly Handle</h3>
