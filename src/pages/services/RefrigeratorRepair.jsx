    ...
    return (
        <div className="mt-16 py-12 px-6 md:px-16 lg:px-24">
            <div className="max-w-7xl mx-auto">
                {/* Header Title */}
                <h1 className="text-3xl md:text-4xl text-center font-bold mb-4">Refrigerator Services</h1>
                ...
                <div className="flex justify-center">
                    <div className="w-full max-w-4xl">
                        ...
                        <p className="mb-4  text-justify text-gray-700 font-medium">
                            We ensure your refrigerator’s smooth operation, consistent cooling, and hassle-free performance. Whether it's regular servicing, installation, or spare part replacement, we handle it all.
                        </p>
                        <h3 className="text-lg font-bold mt-6 mb-2">Why Choose Us for Refrigerator Repair in Jaipur?</h3>
                        <p className="text-gray-800 font-medium">Finding the right fridge repair expert in Jaipur can be tough — but not when we're just a call away. Here’s why customers trust us when they search for “fridge repair near me in Jaipur</p>
                        ...
                        <h3 className="text-xl font-bold mt-6 mb-2 flex flex-raw">Common Refrigerator Issues We Expertly Handle</h3>
                        <ul className="list-disc pl-5 space-y-2 text-md mt-4 text-justify text-gray-800">
                            ...
                            <li><b>No Cooling / Not Cooling Properly : </b>Is your fridge not cooling effectively? If your refrigerator isn’t keeping food fresh, our technicians will diagnose and fix the issue to restore its cooling performance.</li>
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-md mt-4 text-justify text-gray-800">
                            <li><b>Detailed Diagnosis : </b>Our experts begin with a thorough inspection to accurately identify the issue with your Refrigerator.
                            </li>
                            ...
                            <li><b>Post-Repair Testing : </b> Once the work is done, we run a complete test to ensure your Refrigerator is functioning safely and efficiently.
                            </li>
