    ...
    return (
        <div className="mt-16 py-12 px-6 md:px-16 lg:px-24">
            <div className="max-w-6xl mx-auto">
                {/* Header Title */}
                <h1 className="text-3xl md:text-4xl text-center font-bold mb-4 text-gray-900">Air Compressor Services</h1>
                ...
                <div className="flex justify-center">
                    <div className="w-full max-w-6xl">
                        ...
                        <p className="text-gray-900 text-lg text-justify">
                            Struggling with low pressure, frequent breakdowns, or poor compressor performance? We’ve got your back. From expert installation to scheduled maintenance and emergency repairs, we provide full-spectrum air compressor solutions tailored for homes, workshops, factories, and commercial setups. Whether it’s a piston, screw, or oil-free compressor. we bring back efficiency and reliability without delay.
                            Because in your line of work, compressed air isn’t optional it’s essential. Let us keep the pressure steady so your productivity never drops.</p>
                        ...
                        <ul className="list-disc pl-5 space-y-3 text-lg mt-4 text-justify text-gray-900">
                            <li><b>Air Compressor Installation : </b>We deliver expert air compressor installation tailored for both industrial and residential/workshop setups. Our process includes solid base mounting, secure electrical wiring, leak-proof air line connections, and proper ventilation planning to prevent overheating. Whether you're powering heavy machinery or small pneumatic tools, we ensure precise calibration, safety checks, and optimal airflow alignment. so your compressor runs smoothly, efficiently, and reliably from day one.</li>

                            <li><b>Low or Fluctuating Air Pressure : </b>Inconsistent air pressure can disrupt tools and machinery. We check for leaks, faulty regulators, clogged filters, and valve defects to restore consistent performance.</li>

                            <li><b>Unusual Noise or Vibration :  </b>Rattling, banging, or screeching sounds indicate loose mounts, worn bearings, or internal damage. We inspect and repair all moving parts for smooth and silent operation.</li>

                            <li><b>Compressor Not Starting : </b>If your unit won’t turn on, it may be due to electrical issues, pressure switch failure, or motor malfunction. Our technicians identify the fault and bring your machine back online safely.</li>

                            <li><b>Overheating During Operation : </b>Heat buildup reduces efficiency and lifespan. We check for blocked vents, oil levels, and cooling fan issues to prevent overheating and ensure optimal performance.</li>

                            <li><b>Air or Oil Leaks : </b>Leaks around hoses, tanks, or internal seals not only waste energy but also signal deeper issues. We trace the leaks and fix them properly to maintain pressure and safety.</li>

                            <li><b>Frequent Tripping or Blown Fuses : </b>Electrical overloads or faulty components can cause your system to trip. We perform detailed diagnostics to eliminate the root cause and prevent future interruptions.</li>
                        ...
                        <ul className="list-disc pl-5 space-y-3 text-lg mt-4 text-justify text-gray-900">
                            ...
                            <li><b>Performance Testing : </b>After repairs, we run pressure, temperature, and leak tests to ensure your system is performing safely and efficiently under load.</li>

                            <li><b>Customer Satisfaction Check : </b>We walk you through the work done and only consider the job complete when you’re fully satisfied. Your uptime is our priority.</li>
                        </ul>
