...
//                     <button className="text-blue-700 text-md cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
...
const Footer = () => {
    return (
        <footer className="bg-gray-900 text-white py-10">
            ...
            {/* Footer Bottom */}
            <div className="mt-8 border-t border-gray-700 pt-4 px-6">
                {/* Floating Buttons */}
                <div className="fixed bottom-5 left-5 z-50">
